  ...
  return (
   <section className='px-5 pt-0 pb-10 md:pb-16'>
        <div className='max-w-7xl mx-auto'>
            <h2 className='text-center font-epilogue text-(--main-primary-text-color) text-2xl md:text-5xl font-semibold pb-8 md:pb-0 leading-normal md:leading-14'>Take a look at our users <br/> sharing their healing journey</h2>
            <UserTestimonials />          
