  ...
  return (
   <section className='px-5 pt-0 pb-10 md:pb-16'>
        <div className='max-w-[var(--max-width)] mx-auto'>
            ...
            <UserTestimonials />
            <h5 className='text-[#6E6E6E] font-epilogue text-lg md:text-3xl text-center font-medium pt-6 mb-5 md:mb-10'>Have a success story with icanheal? <br/> We’d love to hear from you!</h5>
