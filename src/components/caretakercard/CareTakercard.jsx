    ...
    <section className="px-5 pt-0 pb-10 md:pb-16 bg-[#ffe8dd] md:bg-white">
      <div className="max-w-[var(--max-width)] mx-auto">
        <div
          ...
          style={{
            backgroundImage: `linear-gradient(to top, #FFE8DD 50%, transparent), url("/assets/caretakercardbg.jpg")`,
          }}
        >
          <div className="flex flex-col justify-end md:h-auto lg:h-[800px]">
            <div className="flex flex-col lg:flex-row justify-between mb-3 md:mb-5 lg:mb-10">
              <div className="md:w-full lg:w-[42%]">
                <span className="font-epilogue font-medium text-2xl text-[var(--main-primary-text-color)]">
                  ICanHeal as Caretaker
                </span>
                <h4 className="font-epilogue text-3xl md:text-4xl lg:text-4xl xl:text-6xl font-semibold text-[var(--main-primary-text-color)]">
                  Your Personal Care Manager
                </h4>
              </div>
              <div className="md:w-full lg:w-[48%]">
                <p className="text-lg text-[var(--main-primary-text-color)] font-light">
            ...
            <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4">
              <div className="bg-white rounded-2xl shadow-2xl p-4">
                <span className="mb-2 md:mb-10 inline-flex justify-center w-10 h-10 bg-[var(--main-theme-background)] rounded-full px-2">
                  <Image
                ...
                <h2 className="font-epilogue text-lg md:text-2xl text-[var(--main-primary-text-color)] border-b-2 border-[#beb9b9] pb-2 md:pb-8">
                  Care Manager
                </h2>
        ...
        <Image src={'/assets/bg_plan_one.png'} width={1200} height={600} alt="CareTaker Card " />
          <div className="flex flex-col justify-end md:h-auto lg:h-[800px] pt-2">
            <div className="flex flex-col lg:flex-row justify-between mb-3 md:mb-5 lg:mb-10">
              <div className="md:w-full lg:w-[42%]">
                <span className="font-epilogue font-medium text-2xl text-[var(--main-primary-text-color)]">
                  ICanHeal as Caretaker
